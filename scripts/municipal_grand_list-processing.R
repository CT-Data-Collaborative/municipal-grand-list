...
#"/home/jdaly/Desktop/Data/OPM-fiscal-indicators/Municipal-Grand-List/raw/components"

legacy_GL_csvs <- dir(componentGL_file_path, pattern = "componentGL")
#"componentGL_2014.csv" "componentGL_2015.csv"

sort(legacy_GL_csvs)

#selects latest version of componentGL file 
last_GL_file <- tail(legacy_GL_csvs, 1)
#"componentGL_2015.csv"

legacy_GL_file_path <-file.path(getwd(), "raw", "components", last_GL_file)
#"/home/jdaly/Desktop/Data/OPM-fiscal-indicators/Municipal-Grand-List/raw/components/componentGL_2015.csv"
